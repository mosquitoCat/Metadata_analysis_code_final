...
integrated <- progeny(integrated, scale = FALSE, organism = "Human", top = 500, perm = 1, return_assay = TRUE)
...
new_summary <- summarise_progeny_scores_df
...
rownames(new_summary) <- c("cHF Adult", "dHF Adult", "Uninjured Adult", "Uninjured Fetal")
progeny_hmap = pheatmap(new_summary,fontsize=12, 
                        fontsize_row = 10, 
...
progeny_hmap1 = pheatmap(new_summary,fontsize=12, 
                        fontsize_row = 10, 
                         color=viridisLite::viridis(20), 
                         main = "PROGENy pathway", angle_col = 45,
                         treeheight_col = 0,  border_color = "white")
...
progeny_hmap = pheatmap(new_summary,fontsize=12, 
                        fontsize_row = 10, 
                         color=viridisLite::viridis(20), 
                         main = "", angle_col = 45, border_color = "white",display_numbers = TRUE, number_color = "white")
```
</div>